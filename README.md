...
The BPMs cannot be distributed due to a decompression issue in PyPI. They must be downloaded from the GTC website.
...
__NOTE__: You must download the BPM files from the GTC website and include the path to the BPMs in the configuration file.
